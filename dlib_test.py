# -*- coding: utf-8 -*-
"""
Created on Wed Jan 25 18:24:59 2023
...
models_path = "F:\GitHub\konstruktor-face-recon\data\models\\"
predictor_path = models_path+"shape_predictor_5_face_landmarks.dat"
face_rec_model_path = models_path+"dlib_face_recognition_resnet_model_v1 (1).dat"
faces_folder_path = "F:/GitHub/konstruktor-face-recon/data/full_images/"
...
for f in glob.glob(os.path.join(faces_folder_path, "*.jpg")):
    ...
    for k, d in enumerate(dets):
        ...
        face_descriptor = facerec.compute_face_descriptor(img, shape, 50, 0.25)
        
        validated = distance.euclidean(fd1, face_descriptor) < 0.6
        print(validated)
